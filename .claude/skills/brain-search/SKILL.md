---
name: brain-search
description: Query Drift Brain for decisions, learnings, and patterns
---

# Brain Search

Query the Drift Brain SQLite knowledge graph. Ask about past decisions, reusable patterns, or hot files.
...
Brain only stores decisions made in Drift workflows. To add decisions manually:
