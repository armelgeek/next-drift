...
All Drift projects (including CV Optimizer, MOOZ, etc.) now have automatic migration support for both **local PostgreSQL** and **Neon**.
...
3. Run `pnpm db:push` — works everywhere
