...
3. Name: "Drift Bot", select workspace
...
curl -X POST $SLACK_WEBHOOK_URL -d '{"text":"Test from Drift"}'
```
...
3. Create folder: `Obsidian Vault/Drift/PRDs`
