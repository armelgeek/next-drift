# Drift Brain — Getting Started

Drift Brain is an SQLite knowledge graph that learns from your development sessions and helps you make better decisions faster.
