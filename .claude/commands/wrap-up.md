...
## 3. Record Decisions to Drift Brain (NEW)
...
Examples:
```
DECISION: domain="database" question="Use Drizzle migrations or manual SQL?" answer="Drizzle with auto-generated migrations (pnpm db:generate)" confidence=0.95 locked=true
