---
name: ship-feature
description: "Ship features with Drift Brain: auto-clarify → scout → architect → build → record"
---

# /ship-feature — Ship a Feature Fast

Deliver a feature from spec to production using Drift Brain for smarter decisions.
