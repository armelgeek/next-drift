---
name: ship
description: "Ship with Drift Brain: auto-clarify → scout → architect → build → verify → deploy"
---

# /ship — Intelligent Delivery Pipeline

Ship features, bugs, chores, or incidents. Drift Brain learns and improves every delivery.
...
## Full Workflow (Drift Brain Enhanced)
...
### Add a Feature (Full Drift Brain)
```
